# тестовое задание на позицию Python Junuor разработчика в компанию Bewise.ai
Задачи:
...
# Как разворачивать систему

Для работы апи понадобится python 3.11+ и [docker-compose](https://github.com/docker/compose).
Потребуется создать виртуальное окружение и активировать его.
